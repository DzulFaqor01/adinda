...
<div class="form-group required">
	<label class="col-sm-2 control-label" for="">Brand</label>
	<div class="col-md-10">
		<select name="merek" id="merek" class="form-control select2 ajx" required="" data-placeholder="Pilih Brand" style="width: 100%">
		</select>
...
<div class="form-group required">
	<label class="col-sm-2 control-label" for="">Size</label>
	<div class="col-md-10">
		<select name="ukuran" id="ukuran" class="form-control select2 ajx" required="" data-placeholder="Pilih Size" style="width: 100%">
		</select>
		<a href="<?=base_url(akses().'/produk/ukuran');?>" class="btn btn-link" target="_blank">+ Tambah Size</a>
	</div>
</div>
...
<div class="form-group required">
	...
	<div class="col-md-5">
		<input type="number" name="stok" id="" class="form-control " autocomplete="off" placeholder="Stok produk" required="" value="<?php echo set_value('stok', '1'); ?>" readonly/>
	</div>
</div>
<div class="form-group required">
