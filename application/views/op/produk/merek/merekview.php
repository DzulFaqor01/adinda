...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-default">
		  <div class="panel-heading">Tambah Brand</div>
		  <div class="panel-body">
		    <?php echo form_open(base_url(akses().'/produk/merek/add'));?>
		    <div class="form-group required">
		    	<label class="ctl">Nama Brand</label>
		    	<input type="text" name="nama" class="form-control" required="" placeholder="Nama Brand" value="<?=set_value('nama');?>"/>
		    </div>		    
