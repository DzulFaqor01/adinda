...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-default">
		  <div class="panel-heading">Tambah Size</div>
		  <div class="panel-body">
		    <?php echo form_open(base_url(akses().'/produk/ukuran/add'));?>
		    <div class="form-group required">
		    	<label class="ctl">Size</label>
		    	<input type="text" name="nama" class="form-control" required="" placeholder="Nama Size" value="<?=set_value('nama');?>"/>
		    </div>		    
