...
class Produk_model extends CI_Model
{
	...
	function produk_add_single($toko,$kode,$nama,$supplierID,$merekID,$kategoriID,$ukuranID,$deskripsi,$stok,$harga,$berat='1',$photo='')
	{		
		$d=array(
		'kode_produk'=>$kode,
		'nama_produk'=>$nama,
	...
	function produk_edit($produkID,$kode,$nama,$supplierID,$merekID,$kategoriID,$ukuranID,$deskripsi,$harga,$berat='1',$photo='')
	{
		$s=array(
		'produk_id'=>$produkID,
		);
