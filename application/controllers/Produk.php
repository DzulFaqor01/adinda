...
class Produk extends CI_Controller
{
	...
	function kategori()
	{
		...
		$meta['judulhalaman']= $nama;
		$meta['homepage']=FALSE;
		$this->load->view('html/headerfront',$meta);
		$d['kategoriid']=$id;
		$this->load->view('html/page/three',$d);
	...
	function beli()
	{
		...
		if($this->m_db->is_bof('produk',$s)==FALSE)
		{
			...
			if($this->form_validation->run()==TRUE)
			{
				...
				$this->load->view('html/page/four',$d);
				$this->load->view('html/footerfront');
			}			
		}else{
			redirect(base_url());
	...
	function keranjang()
	{
		...
		$meta['judulhalaman']="Detail Pesanan";
		$meta['homepage']=FALSE;
		$this->load->view('html/headerfront',$meta);
		$this->load->view('html/page/second', $meta);
		$this->load->view('html/footerfront');
		}
	}
	...
	function selesai()
{
    ...
    else
    {
        ...
        else
        {
            ...
            $meta['judulhalaman'] = "Detail Pembayaran";
            $meta['homepage'] = FALSE;
            $this->load->view('html/headerfront', $meta);
            $this->load->view('html/page/eleven');
            $this->load->view('html/footerfront');
        }            
    }
}
