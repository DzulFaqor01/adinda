...
class Produk extends CI_Controller {
	...
	function add()
	{
		...
		$this->form_validation->set_rules('ukuran','Size Produk','required');
		$this->form_validation->set_rules('merek','Brand Produk','required');
		...
		if($this->form_validation->run()==TRUE)
		{
			...
			$photo='upload';
			if($this->mod_produk->produk_add_single($toko,$kode,$nama,$supplier,$merek,$kategori,$ukuran,$deskripsi,$stok,$harga,$berat,$photo)==TRUE)
			{
	...
	function edit()
	{
		...
		if($this->form_validation->run()==TRUE)
		{
			...
			$deskripsi=$this->input->post('deskripsi',TRUE);
			$photo='upload';
			if($this->mod_produk->produk_edit($produkid,$kode,$nama,$supplier,$merek,$kategori,$ukuran,$deskripsi,$harga,$berat,$photo)==TRUE)
			{				
